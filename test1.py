...
# ── 4. THIẾT LẬP FILE EXCEL VÀ CHIA THÀNH 3 PHẦN 
wb = Workbook()
...
headers = ['STT', 'MSSV', 'Họ và Tên', 'GPA Hệ 4', 'Xếp Loại', 'Đánh giá chi tiết môn học']
...
# --- PHẦN 2: TAB TỔNG HỢP THỐNG KÊ & BIỂU ĐỒ ---
...
# ── 5. LƯU FILE KẾT QUẢ ──────────────────────────────────────────────────────
OUTPUT_PATH = 'Phan_cum_sinh_vien_K58KTP.xlsx'
wb.save(OUTPUT_PATH)
print("=" * 70)
print(f"🎉 Sửa lỗi test1.py thành công! File Excel chia 3 tab riêng biệt:")
print(f"📍 {OUTPUT_PATH}")
print("=" * 70)